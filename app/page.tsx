...
import { Upload, MessageSquare, PlusCircle, Link as LinkIcon, Users, FileText, ArrowRight, Shield } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex-grow flex flex-col p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-[#FFF8E7] rounded-3xl p-8 sm:p-14 mb-12 relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-black leading-[1.05] tracking-tight mb-6 uppercase">
            THE ANONYMOUS<br/>FEEDBACK ENGINE.
          </h1>
      ...
      {/* Action Cards Grid */}
      <h2 className="text-2xl font-bold text-black tracking-tight mb-6 uppercase">Platform Actions</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-12">
        ...
        <Link href="/upload" className="group bg-white rounded-2xl border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:border-gray-200 transition-all shadow-sm">
          ...
          <p className="text-sm text-gray-500 font-medium mb-4 flex-grow">Upload your files securely for peer review and structured critique.</p>
        ...
        <Link href="/upload" className="group bg-white rounded-2xl border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:border-gray-200 transition-all shadow-sm">
          ...
          <p className="text-sm text-gray-500 font-medium mb-4 flex-grow">Have a live site? Drop the URL directly and start getting instant feedback.</p>
        ...
        <div className="group bg-white rounded-2xl border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:border-gray-200 transition-all shadow-sm cursor-pointer">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">Enter Chat Room</h3>
          <p className="text-sm text-gray-500 font-medium mb-4 flex-grow">Join an active anonymous discussion room to talk about tech, design, or ideas.</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col shadow-sm">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">Create Chat Room</h3>
          <p className="text-sm text-gray-500 font-medium mb-4">Start your own anonymous room.</p>
