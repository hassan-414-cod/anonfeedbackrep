...
const DUMMY_PROJECTS = [
  {
    ...
    description: "A minimal, nature-inspired journaling app that helps you reflect and grow daily.",
    category: "Web App",
    owner_handle: "Hassan Mahmud",
    cover_image_url: "https://images.unsplash.com/photo-1448375240586-882707db888b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    upvotes: 120
  },
  {
    id: "dummy-2",
    title: "Your AI Assistant",
    description: "An AI agent that helps you ship faster by writing code and automating workflows.",
    category: "AI Agent",
    owner_handle: "Alex Chen",
    cover_image_url: "https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    upvotes: 95
  },
  {
    id: "dummy-3",
    title: "Track habits, build momentum.",
    description: "A dark-themed mobile app designed for habit tracking with detailed analytics.",
    category: "Mobile App",
    owner_handle: "Jamie Park",
    cover_image_url: "https://images.unsplash.com/photo-1616469829581-73993eb86b02?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    upvotes: 310
  }
];
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex-grow flex flex-col p-4 sm:p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4 pt-4">
        <div>
          <h2 className="text-3xl font-bold text-black tracking-tight mb-1 uppercase">FEED</h2>
          <p className="text-gray-500 font-medium">Top recommended projects around the globe.</p>
        </div>
             ...
             <Link href={`/project/${proj.id}`} key={proj.id} className="group bg-white rounded-2xl border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:border-gray-200 transition-all shadow-sm">
               ...
               <div className="w-full h-48 bg-gray-50 rounded-xl mb-6 relative overflow-hidden group-hover:opacity-90 transition-opacity flex items-center justify-center border border-gray-100">
                  {proj.cover_image_url ? (
                    <img src={proj.cover_image_url} className="w-full h-full object-cover" alt={proj.title} />
                  ) : (
